...
const quickLinks = [
  { label: "Home", href: "/" },
  { label: "About & Guidelines", href: "/about" },
  { label: "RSVP for Event", href: "/rsvp" },
  { label: "Apply for Membership", href: "/apply" },
  { label: "OnSite Real Estate", href: "https://www.onsiteregroup.com", external: true },
];

const socialLinks = [
  {
    label: "Facebook",
    href: "https://www.facebook.com/groups/tappsbusinesspublic",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://www.instagram.com/tappsbusinessconnect/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/playlist?list=PLYHpaJehkXfudU9HV_vkDGzfJMu2F098L",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          ...
          >
            ...
            <p className="text-[13px] text-white/50 leading-relaxed">
              Founded by André &amp; Cindie Bohall
              <br />
              <a
        ...
        <div className="mx-auto max-w-[1440px] px-6 lg:px-12 py-6">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-[12px] text-white/25">
              Copyright &copy; {new Date().getFullYear()} | Tapps Business Connect | All Rights Reserved
            </p>
            <div className="flex items-center gap-3">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-[12px] text-white/25 hover:text-white/50 transition-colors mr-4"
              >
